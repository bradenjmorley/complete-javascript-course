...
const restaurant = {
  ...
  orderPizza(mainIndgredient, ...otherIngredients) {
...
const { sat, ...daysOfWeek } = restaurant.hours;
...
let printGoals = function (...goalScorers) {
...
let questionStr = question.get('question') + '\n';
for (const [key, value] of question) {
  if (typeof key === 'number') {
    questionStr += `Answer ${key}: ${value}\n`;
  }
}
const answer = 3; //Number(prompt(questionStr));
...
console.log('test'.padStart(20, '_'));
